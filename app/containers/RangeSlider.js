	...
	return (
		<View style={[styles.container, {borderColor: themes[theme].separatorColor}]}>
			...
			<View style={styles.content}>
				<Text style={[styles.valueText, {color: themes[theme].actionColor}]}>{low}</Text>
				<Slider
					...
					renderLabel={(v) => <View style={styles.labelContainer}><Text style={styles.label}>{v}</Text></View>}
				...
				/>
				<Text style={[styles.valueText,{color: themes[theme].actionColor}]}>{high}</Text>
			</View>
		</View>
	);
};
