...
export const dateStringFromNow = (date) => {
    ...
    if (interval > 1) {
        ...
        return Math.floor(interval) + " " + (value > 1?I18n.t("years"):I18n.t("year")) + I18n.t("ago");
    }
    interval = seconds / 2592000;
    if (interval > 1) {
        const value = Math.floor(interval);
        return Math.floor(interval) + " " + (value > 1?I18n.t("months"):I18n.t("month")) + I18n.t("ago");
    }
    interval = seconds / 86400;
    if (interval > 1) {
        const value = Math.floor(interval);
        return Math.floor(interval) + " " + (value > 1?I18n.t("days"):I18n.t("day")) + I18n.t("ago");
    }
    interval = seconds / 3600;
    if (interval > 1) {
        const value = Math.floor(interval);
        return Math.floor(interval) + " " + (value > 1?I18n.t("hours"):I18n.t("hour"))+ I18n.t("ago");
    }
    interval = seconds / 60;
    if (interval > 1) {
        const value = Math.floor(interval);
        return Math.floor(interval) + " " + (value > 1?I18n.t("minutes"):I18n.t("minute")) + I18n.t("ago");
    }
    return Math.floor(seconds) + " " + (seconds > 1?I18n.t("seconds"):I18n.t("second")) + I18n.t("ago");
}
